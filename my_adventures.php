 ...
 <!--   <header class="image-bg-fluid-height">
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="section-heading">My Adventures</h1>
                    <p class="lead section-lead">Below are the adventures posted by you.</p>
                </div>
            </div>
            <?php 
						$by_id = $_SESSION['user']['id'];
						$sql = "SELECT
adventure.id,						
adventure.title,
...
adventure.`status` = 1 AND by_id = $by_id
 order by adventure_id desc";
    ...
    <strong>0</strong> People voted,<strong><?php echo $row['comments']; ?></strong> comments, 
    
    
    
    <span class="pull-right"><a href="./details.php?id=<?php echo $row['id'];?>" > View Details</a></span>
    <span class="pull-right"><a href="./edit_adventure.php?id=<?php echo $row['id'];?>">Edit Adventure</a>  OR&nbsp;</span>
